Here is a solution.
Algorithm: Implementation:Time Complexity:  O(n)
Auxiliary Space:  O(1)Tags: Linked ListsLike arrays, Linked List is a linear data structure.  Unlike arrays, linked list elements are not stored at contiguous location; the elements are linked using pointers.Why Linked List?
